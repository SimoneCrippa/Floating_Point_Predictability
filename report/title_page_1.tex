...
Hurst exponent is used to determine if a time series have a long-range dependence:
\begin{itemize}
	\item If the Hurst exponent is included in the 0.5-1 range, the time series have a long-term positive autocorrelation.
	\item If the Hurst exponent is equal to 0.5, we have two cases:
	\begin{itemize}
		\item A completely uncorrelated time series.
		\item The absolute values of the autocorrelations of the time series decay exponentially to zero.
	\end{itemize}
	\item If the Hurst exponent is included in the 0.5-1 range, the time series have alternating high and low values in adjacent pairs, this tendency lasts a long time in the future.
\end{itemize}
