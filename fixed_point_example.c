...
int main(){
	...
	float floating_point_value1 = ((float)fixed_mul_64(fixed_point_value1, fixed_point_value2))/scaling_factor;
	float floating_point_value2 = ((float)fixed_div_64(fixed_point_value1, fixed_point_value2))/scaling_factor;
